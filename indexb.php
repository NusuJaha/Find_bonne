...
<div class="container">
  ...
  <div class="container" align="center">
    <p align="right">HI-  <?php echo $_SESSION['username']?>  -  <a href="logoutb.php"><button type="button" class="btn btn-light btn-lg" >Logout</button></a></p>
...
$(document).ready(function(){
 ...
 {
  $.ajax({
   url:"fetch_user_chat_historyb.php",
   method:"POST",
 ...
 $(document).on('focus', '.chat_message', function(){
  var is_type = 'yes';
  $.ajax({
   url:"update_is_type_statusb.php",
   method:"POST",
